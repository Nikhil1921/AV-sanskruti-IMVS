                                    ...
                                    <tr>
                                        <td width="412" align="left" valign="top">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td align="left" valign="top" style="font-family:Arial,Helvetica,sans-serif;font-size:11px;color:#373737"><strong>Standard: </strong></td>
                                                    <td align="left" valign="top" style="font-family:Arial,Helvetica,sans-serif;font-size:11px;color:#373737"><?= $category['cat_name'] ?></td>
                                                </tr>
                                                <tr>
                                                    <td align="left" valign="top" style="font-family:Arial,Helvetica,sans-serif;font-size:11px;color:#373737"><strong>Exam board: </strong></td>
                                                    <td align="left" valign="top" style="font-family:Arial,Helvetica,sans-serif;font-size:11px;color:#373737"><?= $data['exam_board'] ?></td>
                                                </tr>
                                                <tr>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td align="left" valign="top" style="background-color:#f7f7f7;border:solid 1px #e4e6eb">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td width="51%" height="19" align="right" valign="top" style="font-family:Arial,Helvetica,sans-serif;font-size:11px;color:#373737">Exam Fees :</td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td height="20" align="right" valign="bottom" style="font-family:Arial,Helvetica,sans-serif;font-size:11px;color:#373737"><strong><?= $category['price'] ?></strong></td>
                                                            </tr>
                                                        </tbody>
                                                        </table>
                                                    </td>
